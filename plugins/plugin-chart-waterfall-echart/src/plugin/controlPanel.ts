...
import { ControlPanelConfig, D3_FORMAT_DOCS, D3_FORMAT_OPTIONS, D3_TIME_FORMAT_OPTIONS, formatSelectOptions, sections, sharedControls } from '@superset-ui/chart-controls';
        ...
        [
          {
            name: 'cols',
            config: {
              ...sharedControls.columns,//.groupby,
              label: t('Series'),
